...
public class HangiKahve {
    ...
    static String arrBardak[] = {"Küçük Boy", "Orta Boy", "Büyük Boy", "Double Boy"};
    ...
    public void startKahve(){
        ...
        Kahve kahve5 = new Kahve("5","Cappicino");
        kahve.add(kahve1);
        kahve.add(kahve2);
        kahve.add(kahve3);
        kahve.add(kahve4);
    ...
    private void sekerSecim() {
        System.out.println("Şeker ister misiniz? Evet için 'E' Hayır için 'H' giriniz : ");
    ...
    private void sutSecim(){
        System.out.println("Kahvenize süt ister misiniz? Evet için 'E' Hayır için 'H' giriniz : ");
        char secim = scan.next().toUpperCase().charAt(0);
        if (secim == 'E'){
    ...
    private void kahveCikis(){
        ...
        if (ch == 'E'){
            System.out.println(kh.getKahveAdi() +  " hazırlanıyor.");
